-- Modulo:VociRecenti
-- Versione 8.31 - formatTimestamp: rimosso suffisso ' UTC' dall'ora visualizzata.
--                I timestamp sono ora in ora italiana (CET/CEST) grazie al bot v8.41.
...
function p.debugVoce(frame)
    ...
    table.insert(output, "* Versione modulo: 8.31\n")
    for i, tmpl in ipairs(templates) do
        local t1 = tmpl[1]
        local t2 = tmpl[2]
